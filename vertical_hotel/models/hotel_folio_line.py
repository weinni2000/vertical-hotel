...
class HotelFolioLine(models.Model):
    _name = "vertical_hotel.folio.line"
    ...
    folio_id = fields.Many2one("vertical_hotel.folio", "Folio", ondelete="cascade")
    ...
    def _update_folio_line(self, records):
        ...
        Works with:
          - vertical_hotel.folio   → updates all its room_line_ids
          - vertical_hotel.folio.line → updates only given lines
        """
        FolioRoomLine = self.env["folio.room.line"]
        hotel_room_obj = self.env["vertical_hotel.room"]
        ...
        rooms_to_update = self.env["vertical_hotel.room"]
        vals_list = []
    ...
    def create(self, vals_list):
        ...
        """
        Folio = self.env["vertical_hotel.folio"]
